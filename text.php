...
$textbotlang['users']['Extra_volume']['ErrorExtra'] = "❌ متأسفانه در حال حاضر امکان افزودن حجم به سرویس شما وجود ندارد.
💳 مبلغ پرداختی به کیف پول شما بازگردانده شد.
📞 لطفاً جهت پیگیری با پشتیبانی در ارتباط باشید.";
...
$textbotlang['users']['customuserchoice'] = 'دلخواه یا رندوم (انتخاب با کاربر)';
$textbotlang['users']['selectusernamechoice'] = "می‌تونید نام کاربری دلخواه خودتون بفرستین یا بصورت رندوم انتخاب میشه\n\nیکی از گزینه‌ها رو انتخاب کنین:";
...
۳ - اینباند و پروکسی‌ها از داشبورد پنل مدیریت می‌شن، نیازی به «تنظیم پروتکل و اینباند» نیست.";
...
$textbotlang['Admin']['managepanel']['keyboardpanel']['editmitcred'] = "🔑 ویرایش اطلاعات اتصال";
...
🛍 حجم خریداری شده  : %s
💰 مبلغ پرداختی : %s تومان";
$textbotlang['Admin']['Report']['ErrorExtraVolume'] = "⚠️ خطا در افزایش حجم سرویس (مبلغ به کاربر بازگردانده شد)
✍️ دلیل خطا :
%s
🪪 آیدی عددی کاربر : %s
👤 نام کاربری سرویس : %s";
